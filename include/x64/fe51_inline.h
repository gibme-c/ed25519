...
*/
#ifndef ED25519_X64_FE51_INLINE_H
#define ED25519_X64_FE51_INLINE_H
...
static ED25519_FORCE_INLINE void fe51_mul_inline(fe h, const fe f, const fe g)
{
    ...
    ed25519_uint128 h0 = mul64(f0, g0) + mul64(f1, g4_19) + mul64(f2, g3_19) + mul64(f3, g2_19) + mul64(f4, g1_19);
    ed25519_uint128 h1 = mul64(f0, g1) + mul64(f1, g0) + mul64(f2, g4_19) + mul64(f3, g3_19) + mul64(f4, g2_19);
    ed25519_uint128 h2 = mul64(f0, g2) + mul64(f1, g1) + mul64(f2, g0) + mul64(f3, g4_19) + mul64(f4, g3_19);
    ed25519_uint128 h3 = mul64(f0, g3) + mul64(f1, g2) + mul64(f2, g1) + mul64(f3, g0) + mul64(f4, g4_19);
    ed25519_uint128 h4 = mul64(f0, g4) + mul64(f1, g3) + mul64(f2, g2) + mul64(f3, g1) + mul64(f4, g0);
    ...
    ed25519_uint128_emu h0 = mul64(f0, g0);
    h0 += mul64(f1, g4_19);
    h0 += mul64(f2, g3_19);
    h0 += mul64(f3, g2_19);
    h0 += mul64(f4, g1_19);

    ed25519_uint128_emu h1 = mul64(f0, g1);
    h1 += mul64(f1, g0);
    h1 += mul64(f2, g4_19);
    h1 += mul64(f3, g3_19);
    h1 += mul64(f4, g2_19);

    ed25519_uint128_emu h2 = mul64(f0, g2);
    h2 += mul64(f1, g1);
    h2 += mul64(f2, g0);
    h2 += mul64(f3, g4_19);
    h2 += mul64(f4, g3_19);

    ed25519_uint128_emu h3 = mul64(f0, g3);
    h3 += mul64(f1, g2);
    h3 += mul64(f2, g1);
    h3 += mul64(f3, g0);
    h3 += mul64(f4, g4_19);

    ed25519_uint128_emu h4 = mul64(f0, g4);
    h4 += mul64(f1, g3);
    h4 += mul64(f2, g2);
    h4 += mul64(f3, g1);
    h4 += mul64(f4, g0);
...
static ED25519_FORCE_INLINE void fe51_sq_inline(fe h, const fe f)
{
    uint64_t f0 = f[0], f1 = f[1], f2 = f[2], f3 = f[3], f4 = f[4];
...
#endif // ED25519_X64_FE51_INLINE_H
