...
*/
#ifndef ED25519_REF10_FE25_CHAIN_H
#define ED25519_REF10_FE25_CHAIN_H

/*
 * Chain operation primitives for portable ge inlining.
 *
 * All compilers get force-inlined portable mul/sq — the portable implementation
 * uses only int32_t * int64_t (no struct emulation), so force-inlining is
 * safe on all compilers including MSVC.
 */

#include "portable/fe25_inline.h"

#define fe25_chain_mul fe25_mul_inline
#define fe25_chain_sq fe25_sq_inline

static ED25519_FORCE_INLINE void fe25_sq2_inline(fe h, const fe f)
{
...
#define fe25_chain_sq2 fe25_sq2_inline

static ED25519_FORCE_INLINE void fe25_sqn_inline(fe h, const fe f, int n)
{
    fe25_sq_inline(h, f);
    for (int i = 1; i < n; i++)
        fe25_sq_inline(h, h);
...
#define fe25_chain_sqn fe25_sqn_inline

#endif // ED25519_REF10_FE25_CHAIN_H
