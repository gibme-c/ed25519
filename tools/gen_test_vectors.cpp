...
// l - 1
static const unsigned char scalar_l_minus_1[32] = {0xec, 0xd3, 0xf5, 0x5c, 0x1a, 0x63, 0x12, 0x58, 0xd6, 0x9c, 0xf7,
                                                   0xa2, 0xde, 0xf9, 0xde, 0x14, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                                   0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x10};

// Deterministic test scalars (reduced mod l)
static const unsigned char scalar_a[32] = {0x31, 0x3b, 0x3f, 0x84, 0x28, 0x2b, 0xa0, 0x02, 0xb9, 0x4f, 0x8f,
                                           0x4c, 0xf4, 0x39, 0x24, 0xf6, 0xf5, 0x27, 0xd2, 0xf2, 0xdf, 0x36,
                                           0x96, 0x36, 0x11, 0x09, 0x56, 0xa8, 0xa8, 0x5d, 0x98, 0x04};

static const unsigned char scalar_b[32] = {0x18, 0x3c, 0x91, 0x5a, 0x04, 0xd2, 0xbc, 0x1b, 0x03, 0xf4, 0xa7,
                                           0xd9, 0xb1, 0x16, 0x4f, 0xe8, 0xc3, 0xb0, 0x2c, 0x0e, 0x6e, 0x1a,
                                           0x2b, 0xa4, 0x3f, 0xc8, 0x47, 0x8d, 0xd0, 0xa9, 0xe3, 0x02};

static const unsigned char scalar_c[32] = {0x04, 0x7f, 0xed, 0x51, 0x9e, 0x8a, 0xc6, 0x43, 0x0b, 0x1d, 0x5e,
...
static const unsigned char fe_val_a[32] = {0xef, 0xcd, 0xab, 0x90, 0x78, 0x56, 0x34, 0x12, 0xef, 0xcd, 0xab,
                                           0x90, 0x78, 0x56, 0x34, 0x12, 0xef, 0xcd, 0xab, 0x90, 0x78, 0x56,
                                           0x34, 0x12, 0xef, 0xcd, 0xab, 0x90, 0x78, 0x56, 0x34, 0x12};

static const unsigned char fe_val_b[32] = {0x21, 0x43, 0x65, 0x87, 0x09, 0xba, 0xdc, 0xfe, 0x21, 0x43, 0x65,
                                           0x87, 0x09, 0xba, 0xdc, 0xfe, 0x21, 0x43, 0x65, 0x87, 0x09, 0xba,
                                           0xdc, 0xfe, 0x21, 0x43, 0x65, 0x87, 0x09, 0xba, 0xdc, 0x7e};

// p - 1 = 2^255 - 20
static const unsigned char fe_p_minus_1[32] = {0xec, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
...
static void emit_scalar_vectors()
{
    ...
    // --- sc_muladd ---
    {
        printf("    \"muladd\": [\n");
        auto emit_muladd =
            [](const char *label, const unsigned char *a, const unsigned char *b, const unsigned char *c, bool last)
        {
            unsigned char out[32];
            sc_muladd(out, a, b, c);
            printf("      {\n");
