...
/**
 * @file portable/ge_dsm_base_negate_vt_batch.cpp
 * @brief portable fallback for batch DSM (loop over single ops).
 */
    ...
    size_t count)
{
    ...
    {
        ge_p1p1 t;
        ge_double_scalarmult_base_negate_vartime_portable(&t, a_scalars + i * 32, &A_points[i], b_scalars + i * 32);
