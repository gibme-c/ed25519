...
/**
 * @file portable/ge_dsm_negate_vt_batch_ss.cpp
 * @brief portable fallback for shared-scalar batch DSM (loop over single ops).
 */
    ...
    size_t count)
{
    for (size_t i = 0; i < count; i++)
    {
        ...
        ge_p1p1 t;
        ge_double_scalarmult_negate_vartime_portable(&t, a, &A_points[i], b, Bi);
