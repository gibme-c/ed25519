...
/**
 * @file x64/ge_dsm_base_negate_vt_batch.cpp
 * @brief x64 fallback for batch DSM (loop over single ops).
 */
    ...
    size_t count)
{
    ...
    {
        ge_p1p1 t;
        ge_double_scalarmult_base_negate_vartime_x64(&t, a_scalars + i * 32, &A_points[i], b_scalars + i * 32);
